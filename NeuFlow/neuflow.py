...
from NeuFlow import fast_backbone
...
class NeuFlow(torch.nn.Module):
    def __init__(self):
        ...
        self.backbone = fast_backbone.FastEncoder(config.feature_dim_s16, config.context_dim_s16, config.feature_dim_s8, config.context_dim_s8, resolution=384) # 128, 64, 128, 64
